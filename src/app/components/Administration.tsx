...
import { ArchiveRestore, CalendarDays, Database, FlaskConical } from 'lucide-react';
...
export function Administration() {
  ...
  return <SplitPageLayout><PageHeader eyebrow="Systemverwaltung" title="Administration" subtitle="Datenbank, Backups und Tests zentral verwalten." meta={<StatusChip tone="neutral">Geschützter Bereich</StatusChip>}/>
